...
<body><center>
    <form action="courses14.php" method="post">
    <b><h3>تسجيل بيانات المواد القررة ف1</h3></b> 
    <table border=10 height=60% width=60%>
        ...
        <tr><th><b> الترم </b></th><th><input type="text" name="term" id="b"></th><tr>
    ...
    <br>
    <button class="button button2"><a href="vcourses1.php" id='aa'>عرض بيان المواد المقررة فرقة اولى</a></button>
    </form>
</body>
</html>