...
<head>
    ...
    <title>مواد فرقة اولى نظم</title>
    <style type="text/css">
		/*اللون وشكل الزراير*/    
	#a{
...
<body><center>
    <form action="courses1.php" method="post">
	<b><h3>تسجيل بيانات المواد (نظم معلومات ادارية) ف1</h3></b> 
    ...
    <br>
    <button class="button button2"><a href="vcourses1.php" id='aa'>عرض المواد المقررة فرقة اولى نظم</a></button>
    </form>
</body>
</html>
