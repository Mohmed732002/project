...
<body><center>
    <form action="participate.php" method="post">
     <b><h3>تسجيل بيانات الاشتراك</h3></b> 
    <table border=10 height=60% width=60%>
       <tr><th><b> رقم الطالب </b></th><th><input type="text" name="tid" id="b"></th></tr>
       <tr><th><b> اسم الاتوبيس </b></th><th><input type="text" name="bid" id="b"></th><tr>
       <tr><th><b> تاريخ الاشتراك </b></th><th><input type="text" name="subscription_date" id="b"></th><tr>
       <tr><th colspan='2'><input type="submit" value="     حفظ     " id="a">
       <input type="reset" value="     تراجع     " id="a"></th></tr>
    </table>
    <br>
    <button class="button button2"><a href="vparticipate.php" id='aa'>عرض بيان الاشتراك</a></button>
    </form>
</body>
</html>