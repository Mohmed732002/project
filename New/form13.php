...
<body><center>
    ...
    <table border=10 height=60% width=60%>
       ...
       <tr><th><b> النسبة </b></th><th><input type="text" name="ratio" id="b"></th><tr>
       <tr><th><b> السعر </b></th><th><input type="text" name="tprice" id="b"></th><tr>
       <tr><th colspan='2'><input type="submit" value="     حفظ     " id="a">
       <input type="reset" value="     تراجع     " id="a"></th></tr>
    </table>
    <br>
    <button class="button button2"><a href="vtake.php" id='aa'>عرض بيانات يأخذ</a></button>
    </form>
</body>
</html>