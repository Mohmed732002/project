...
<body><center>
    ...
    <h3>تسجيل بيانات جدول يستعير</h3>
    <table border=10 height=60% width=60%>
       ...
       <tr><th><b> تاريخ الاستعارة </b></th><th><input type="text" name="start_date" id="b"></th><tr>
       <tr><th><b> تاريخ الارجاع </b></th><th><input type="text" name="end_date" id="b"></th><tr>
       <tr><th colspan='2'><input type="submit" value="     حفظ     " id="a">
       <input type="reset" value="     تراجع     " id="a"></th></tr>
    </table>
    <br>
    <button class="button button2"><a href="vborrows.php" id='aa'>عرض بيانات جدول يستعير</a></button>
    </form>
</body>
</html>