...
<body><center>
    <form action="coursess4.php" method="post">
	<b><h3>تسجيل بيانات المواد (نظم معلومات ادارية) ف4</h3></b>
    ...
    <br>
    <button class="button button2"><a href="vcoursess4.php" id='aa'>عرض المواد المقررة فرقة اولى نظم</a></button>
    </form>
</body>
</html>