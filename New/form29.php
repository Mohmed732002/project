...
<body><center>
    <form action="coursess2.php" method="post">
	<b><h3>تسجيل بيانات المواد (نظم معلومات ادارية) ف2</h3></b>
    ...
    <br>
    <button class="button button2"><a href="vcoursess2.php" id='aa'>عرض المواد المقررة فرقة ثانية نظم</a></button>
    </form>
</body>
</html>